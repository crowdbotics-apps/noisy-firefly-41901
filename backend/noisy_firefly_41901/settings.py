"""
Django settings for noisy_firefly_41901 project.
...
ROOT_URLCONF = 'noisy_firefly_41901.urls'
...
WSGI_APPLICATION = 'noisy_firefly_41901.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_firefly_41901 API",
    "DESCRIPTION": "API documentation for noisy_firefly_41901 App",
    "VERSION": "v1",
}
